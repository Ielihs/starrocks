...
StatusOr<std::unique_ptr<RandomAccessFile>> JindoFileSystem::new_random_access_file(const std::string& path) {
    return JindoFileSystem::new_random_access_file(RandomAccessFileOptions(), path);
}
