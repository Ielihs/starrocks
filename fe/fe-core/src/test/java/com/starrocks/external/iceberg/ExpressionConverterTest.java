...
public class ExpressionConverterTest {
    ...
    public void testToIcebergExpression() throws AnalysisException {
        ...
        // isNull
        convertedExpression = ExpressionConverter.toIcebergExpression(new IsNullPredicate(ref, false));
        ...
        // notNull
        convertedExpression = ExpressionConverter.toIcebergExpression(new IsNullPredicate(ref, true));
        ...
        convertedExpression= ExpressionConverter.toIcebergExpression(new BinaryPredicate(BinaryPredicate.Operator.EQ, ref, dateLiteral));
        ...
        convertedExpression = ExpressionConverter.toIcebergExpression(new BinaryPredicate(BinaryPredicate.Operator.NE, ref, boolLiteral));
        ...
        convertedExpression = ExpressionConverter.toIcebergExpression(new BinaryPredicate(BinaryPredicate.Operator.LT, ref, intLiteral));
        ...
        convertedExpression = ExpressionConverter.toIcebergExpression(new BinaryPredicate(BinaryPredicate.Operator.LE, ref, intLiteral));
        ...
        convertedExpression = ExpressionConverter.toIcebergExpression(new BinaryPredicate(BinaryPredicate.Operator.GT, ref, intLiteral));
        ...
        convertedExpression = ExpressionConverter.toIcebergExpression(new BinaryPredicate(BinaryPredicate.Operator.GE, ref, intLiteral));
        ...
        convertedExpression = ExpressionConverter.toIcebergExpression(new InPredicate(ref, inListExpr, false));
        expectedExpression = Expressions.in("col_name", inList);
        Assert.assertEquals("Generated in expression should be correct",
                expectedExpression.toString(), convertedExpression.toString());

        // notIn
        convertedExpression = ExpressionConverter.toIcebergExpression(new InPredicate(ref, inListExpr, true));
        ...
        convertedExpression = ExpressionConverter.toIcebergExpression(new FunctionCallExpr("starts_with", params));
        ...
        Expression expression1 = ExpressionConverter.toIcebergExpression(expr1);
        Expression expression2 = ExpressionConverter.toIcebergExpression(expr2);

        convertedExpression = ExpressionConverter.toIcebergExpression(new CompoundPredicate(CompoundPredicate.Operator.OR, expr1, expr2));
